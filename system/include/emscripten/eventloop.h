...
long emscripten_set_timeout(void (*cb)(void *userData) __attribute__((nonnull)), double msecs, void *userData);
...
long emscripten_set_immediate(void (*cb)(void *userData) __attribute__((nonnull)), void *userData);
...
long emscripten_set_interval(void (*cb)(void *userData) __attribute__((nonnull)), double intervalMsecs, void *userData);
